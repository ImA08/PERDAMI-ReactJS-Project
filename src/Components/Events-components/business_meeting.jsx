...
import Img1 from "../../Assets/events/Business_Meeting1.jpg";
import Img2 from "../../Assets/events/Business_Meeting2.jpg";
import Img3 from "../../Assets/events/Business_Meeting3.jpg";
import Img4 from "../../Assets/events/Business_Meeting4.jpg";
import Img5 from "../../Assets/events/Business_Meeting5.jpg";

const Business_meeting = () => {
  return (
    <>
      <div className="starting-point head-symposium">
        <div className="container">
          <h2 className="border-bottom">Business Meeting</h2>
          <div className="row">
...
export default Business_meeting;
