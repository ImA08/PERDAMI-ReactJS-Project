...
import Img1 from "../../Assets/events/Workshop1.jpg";
import Img2 from "../../Assets/events/Workshop2.jpg";
import Img3 from "../../Assets/events/Workshop3.jpg";
import Img4 from "../../Assets/events/Workshop4.jpg";
import Img5 from "../../Assets/events/Workshop5.jpg";
    ...
    <>
      <div className="starting-point head-symposium">
        <div className="container">
          <h2 className="border-bottom">Workshop</h2>
          <div className="row">
